...
public:
    ...
    void sendJointTrajectory(davinci_arm::models::Domain domain,
...
private:
    ...
    void onJointState_(davinci_arm::models::Domain domain,
                       const sensor_msgs::msg::JointState& msg);
    void onControllerState_(const control_msgs::msg::JointTrajectoryControllerState& msg);
    void onTrajectoryExecutionEvent_(const std_msgs::msg::String& msg);

    void emitJointTelemetry_(davinci_arm::models::Domain domain,
                             const std::string& joint_name,
                             double position_rad,
                             const std::optional<double>& velocity_rad_s);

    void emitReferenceTelemetry_(const std::string& joint_name, double ref_position_rad);

    void touchRx_(davinci_arm::models::Domain domain);
    void updateConnection_();

    trajectory_msgs::msg::JointTrajectory buildSinglePointTrajectory_(
...
private:
    ...
    rclcpp::Publisher<trajectory_msgs::msg::JointTrajectory>::SharedPtr pub_real_joint_trajectory_;
    rclcpp::Publisher<trajectory_msgs::msg::JointTrajectory>::SharedPtr pub_sim_joint_trajectory_;
